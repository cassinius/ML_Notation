...
%% This package makes for ugly bold font in math symbols !!!
%\usepackage{arevmath}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\markright{Machine Learning Notation}
...
%NOTE: The PROJECT TITLE should be unique at Google search - and useful for setting up a Website
\normalfont\normalsize
